          ...
          {projects.map((project) => (
            ...
            >
              <Link href={`/work/${project.slug}`}>
                <div className="bg-white rounded-lg overflow-hidden border border-grey-200 hover:shadow-xl transition-all duration-500 group-hover:-translate-y-2">
                  ...
                  <div className="aspect-video bg-gradient-to-br from-grey-200 to-grey-300 flex items-center justify-center">
                    <div className="text-grey-600 text-center">
                      <div className="w-16 h-16 mx-auto mb-4 bg-grey-400 rounded-lg flex items-center justify-center">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-grey-700 mb-6 line-clamp-3">
                      {project.summary}
                    </p>
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-grey-600">{project.client}</span>
