    ...
    <section ref={sectionRef} className="py-24 bg-black text-white">
      <div className="container">
        <div ref={contentRef} className="text-center max-w-4xl mx-auto">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold mb-8 text-balance">
            Ready to Transform Your Business?
          </h2>
          
          <p className="text-xl md:text-2xl text-grey-300 mb-12 text-balance leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
            <Link 
              href="/contact" 
              className="btn btn-primary bg-white text-black hover:bg-grey-100 text-lg px-12 py-6 magnetic"
            >
              Start Your Project
            </Link>
            <a
              ...
              className="btn btn-outline border-white text-white hover:bg-white hover:text-black text-lg px-12 py-6 magnetic"
            >
              WhatsApp Us
            </a>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div>
              <h3 className="font-display font-semibold mb-2">Call or WhatsApp</h3>
              <a 
            ...
            <div>
              ...
              <p className="text-grey-300">Within 4 hours</p>
            </div>
          </div>

          {/* Trust Indicators */}
          <div className="mt-16 pt-12 border-t border-grey-800">
            <div className="flex flex-wrap justify-center items-center gap-8 text-grey-400">
