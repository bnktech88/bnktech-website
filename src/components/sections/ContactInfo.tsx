      ...
      <div className="space-y-6 mb-8">
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            ...
            <a 
              ...
              className="text-grey-700 hover:text-black transition-colors block mb-1"
            >
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            ...
            <a 
              ...
              className="text-grey-700 hover:text-black transition-colors block"
            >
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            ...
            <p className="text-grey-700">Within 4 hours</p>
            <p className="text-sm text-grey-600 mt-1">
      ...
      <div className="bg-grey-50 p-6 rounded-lg">
        ...
        <div className="space-y-3 text-sm">
          <div className="flex items-center">
            <span className="w-6 h-6 bg-black text-white rounded-full flex items-center justify-center text-xs mr-3">1</span>
            <span>We review your project details</span>
          </div>
          <div className="flex items-center">
            <span className="w-6 h-6 bg-black text-white rounded-full flex items-center justify-center text-xs mr-3">2</span>
            <span>Schedule a free 30-minute consultation</span>
          </div>
          <div className="flex items-center">
            <span className="w-6 h-6 bg-black text-white rounded-full flex items-center justify-center text-xs mr-3">3</span>
            <span>Receive a detailed proposal with timeline</span>
          </div>
          <div className="flex items-center">
            <span className="w-6 h-6 bg-black text-white rounded-full flex items-center justify-center text-xs mr-3">4</span>
            <span>Begin development with weekly updates</span>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8 pt-6 border-t border-grey-200">
        <div className="grid grid-cols-2 gap-4 text-center text-sm">
          <div>
            ...
            <div className="text-grey-600">Satisfaction Rate</div>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="text-grey-600">Support Available</div>
          </div>
          <div>
            <div className="font-semibold">Free</div>
            <div className="text-grey-600">Initial Consultation</div>
          </div>
        </div>
      </div>
    </div>
